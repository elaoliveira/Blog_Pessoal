...
public class SwaggerConfig {
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("API - Meu Blog Pessoal").description("Projeto API Spring - Meu Blog Pessoal")
				...
				.licenseUrl("https://github.com/elaoliveira/Blog_Pessoal").contact(contact()).build();
	}

	private static Contact contact() {
		return new Contact("Rafaela Oliveira", "https://github.com/elaoliveira/Blog_Pessoal",
				"rafaela.o.barbosa@gmail.com");
	}
